      ...
      this.apiService.getPromotions().subscribe({
        next: (response: any) => {
          ...
          if (response.success && response.data?.length) {
            ...
            // this.promotionSources = [...this.promotionSources,...this.promotionSources, ...this.promotionSources, ...this.promotionSources, ...this.promotionSources, ...this.promotionSources];
          }
        },
        error: (err) => {
          console.log(err);
